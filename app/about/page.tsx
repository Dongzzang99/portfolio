            ...
            <div style={{ marginTop: 32 }}>
              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    어려운 상황에서도 포기하기보다 해결 방법을 고민하며, 꾸준히
                    성장해 나가고자 합니다.
                  </p>
                </div>
              </div>
              ...
              <div style={{ marginTop: 36 }}>
                ...
                <p className="muted" style={{ lineHeight: 1.9 }}>
                  안녕하세요. “꿈을 이루는 열정과 긍정의 힘”이라는 가치관을
                  바탕으로 꾸준히 성장하고 있는 풀스택 개발자 강동현입니다.
                </p>

                <p className="muted" style={{ lineHeight: 1.9 }}>
                  새로운 환경이나 어려운 문제에 직면했을 때 피하거나
                  포기하기보다, 긍정적인 태도로 해결책을 모색하며 작은 경험을
                  차근차근 쌓아 한 단계씩 성장해 나가는 것을 중요하게
                  생각합니다.
                </p>
              </div>
              ...
              <div style={{ marginTop: 36 }}>
                ...
                <p className="muted" style={{ lineHeight: 1.9 }}>
                  저는 “사용자가 쉽게 이해하고 끝까지 편하게 사용할 수 있는 웹
                  서비스”를 만드는 것을 핵심 가치로 삼고 있습니다.
                </p>

                <p className="muted" style={{ lineHeight: 1.9 }}>
                  React와 SpringBoot 기반의 프로젝트를 진행하며, 실제 서비스
                  구조를 참고해 페이지 흐름, 상태 관리, 컴포넌트 재사용성을
                  고려한 구조로 개발해왔습니다.
                </p>

                <p className="muted" style={{ lineHeight: 1.9 }}>
                  또한 새로운 기술 학습과 리팩토링을 반복하며 프로젝트를
                  점진적으로 개선해 나가고 있습니다.
                </p>
              </div>
              ...
              <div style={{ marginTop: 36 }}>
                ...
                <p className="muted" style={{ lineHeight: 1.9 }}>
                  대학 시절 C++ 기반 Unity 엔진을 활용한 게임 개발 프로젝트를
                  통해 프로그래밍 기초와 협업 경험을 쌓았습니다.
                </p>

                <p className="muted" style={{ lineHeight: 1.9 }}>
                  이후 JavaScript를 시작으로 React, TypeScript, Tailwind CSS,
                  SpringBoot, MySQL까지 기술 스택을 확장하며 웹 개발 역량을
                  강화했습니다.
                </p>

                <p className="muted" style={{ lineHeight: 1.9 }}>
                  강화 시뮬레이션 팀 프로젝트를 통해 실제 사용자 서비스를
                  운영하고, Google Analytics를 활용해 사용자 경험을 분석하고
                  개선한 경험이 있습니다.
                </p>
              ...
              <div style={{ marginTop: 36 }}>
                ...
                <p className="muted" style={{ lineHeight: 1.9 }}>
                  프로젝트를 진행하며 기술적인 문제뿐 아니라 팀 내 소통과 협업을
                  통해 문제를 해결하는 과정을 중요하게 생각합니다.
                </p>

                <p className="muted" style={{ lineHeight: 1.9 }}>
                  팀장과 팀원 역할을 모두 경험하며 의견 충돌 상황에서도 사용자
                  관점을 기준으로 소통하며 최적의 방향을 도출해왔습니다.
                </p>

                <p className="muted" style={{ lineHeight: 1.9 }}>
                  또한 기능 구현 과정에서 발생한 문제를 단순히 해결하는 데
                  그치지 않고, 구조를 개선하고 재발을 방지하는 방향으로
                  접근해왔습니다.
                </p>
              </div>
              ...
              <div style={{ marginTop: 36 }}>
                ...
                <p className="muted" style={{ lineHeight: 1.9 }}>
                  저는 스스로 부족함을 인식하는 것에서 성장이 시작된다고
                  생각합니다.
                </p>
